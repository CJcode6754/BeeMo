    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <div class="reports-page py-3 mt-4 border border-2 rounded-4 border-dark">
                <div class="px-4 py-3  text-center content-wrapper">
                    ...
                    <div class="container-top">
                        ...
                        <div class="label-container btn-group d-flex justify-content-center mb-3">
                        ...
                        <div class="container-label d-flex justify-content-between align-items-center w-100 gap-0 gap-md-2 my-2">
                ...
                <div class="descriptive-analytics-container d-flex justify-content-around mt-2 row row-cols-3 row-cols-lg-6 g-2 g-lg-3">
                    ...
                    <p id="previousWeightContainer">Previous Weight: <span id="previousWeight">-</span></p>
