                    ...
                    <div class="container-top">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
                            ...
                            <div class="select-cycle dropdown">
                                <button class="select-cycle-btn btn btn-outline-dark btn dropdown-toggle" type="button" id="harvestCycleDropdown" data-bs-toggle="dropdown" aria-expanded="false">
