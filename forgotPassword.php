...
// Instantiate OTP and Mailer classes
$otpHandler = new OTP($conn);
$emailHandler = new Mailer();

// Check if the request method is POST and email is set
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ...
    $query = "SELECT admin_name FROM admin_table WHERE email = ?";
                ...
                <div class="col-lg-4 bg1">
                    <div id="LoginLogo" class="container-fluid">
                      <main class="form-signin w-auto m-auto px4">
                            <form action="/forgotPassword" method="post" id="forgotForm" novalidate>
