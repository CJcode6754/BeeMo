    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-3 rounded-4">
                <div>
                    <p class="d-none d-lg-block mt-3 mx-4 fw-bold" style="font-size: 17px;">Welcome to Reports</p>
                </div>
                ...
                <div class="dropdown me-3 d-sm-block">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <!-- Logout -->
                        <form id="logoutForm" action="reports.php" method="post" style="display: none;">
