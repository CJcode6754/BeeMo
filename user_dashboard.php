...
if (isset($_POST['logout_btn'])) {
    ...
    // Set no-cache headers to prevent caching of the login page
...
if (isset($_POST['clearNotif'])) {
        $clearNotif = "DELETE FROM tblNotification WHERE userID = '" . $_SESSION['userID'] . "'";
            ...
            <nav class="px-3 py-3 rounded-4">
                ...
                <div class="dropdown me-3 d-sm-block">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <!-- Logout -->
                        <form id="logoutForm" action="user_dashboard.php" method="post" style="display: none;">
