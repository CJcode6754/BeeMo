...
if (isset($data['start_date'], $data['end_date'], $data['cycle_id'])) {
    ...
    // Enhanced correlation interpretation
    ...
    //                    "between temperature and hive weight. " .
    //                    "As temperature is in optimal range, bees increased foraging activity and honey production. ";
    //         } else {
    //             return "There is a {$strengthText} negative correlation (Correlation Coefficient: " . number_format($correlation, 2) . ") " .
    //                    "between temperature and hive weight. " .
    //                    "The temperature conditions may be causing increased energy expenditure, either from cooling activities " .
    //                    "in high temperatures, leading to higher honey consumption.";
    //         }
    //     } else { // humidity
    //         if ($correlation > 0) {
    //             return "There is a {$strengthText} positive correlation (Correlation Coefficient: " . number_format($correlation, 2) . ") " .
    //                    "between humidity and hive weight. " .
    //                    "The current humidity levels are supporting optimal honey production, " .
    //                    "allowing bees to efficiently process and store honey.";
    //         } else {
    //             return "There is a {$strengthText} negative correlation (Correlation Coefficient: " . number_format($correlation, 2) . ") " .
    //                    "between humidity and hive weight. " .
    //                    "The humidity conditions may be affecting nectar processing efficiency " .
    //                    "that impacts the colony's honey production and storage capabilities.";
    //         }
    //     }
    // }
    ...
    $currentMinWeight = $stats['weight']['min'];
    ...
    //         "This substantial weight reduction indicates severe colony stress cause by temperature fluctuations. Potential causes include: " . 
    ...
    // Add Environmental Correlation Analysis after all weight analyses
