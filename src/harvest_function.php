...
class HarvestCycle {
    ...
    $delete_cycle = "DELETE FROM harvest_cycle WHERE cycle_number = ? AND adminID = ?";
    ...
    $stmt->bind_param('ii', $cycle_num, $adminID);  // 'ii' because both cycle_number and adminID are integers
